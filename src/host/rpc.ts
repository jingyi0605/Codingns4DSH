...
const CODINGNS_RPC_ENDPOINTS = [
  ...
  'cli/catalog', 'cli/models', 'cli/adapter/set', 'cli/session/get', 'cli/session/set', 'cli/session/list', 'cli/session/archive', 'cli/session/steer', 'cli/session/follow-up', 'cli/session/interrupt',
] as const
